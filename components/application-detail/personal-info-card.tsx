  ...
  const handleOtvRequest = async () => {
    if (onOtvRequest) {
      try {
        ...
        console.error("OTV request failed:", error);
      }
    }
  };
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Verify the ID number against official government
                          records
                        </DialogDescription>
                      </DialogHeader>
                                  ...
                                  <Card>
                                    ...
                                    <CardContent className="flex justify-center">
                                      <div className="flex flex-col items-center">
                                        <img
                                          src={`data:image/jpeg;base64,${idVerificationResult.photo}`}
                                          alt="ID Photo"
                  ...
                  >
                    ...
                    {isSendingOtv ? "Sending..." : "Send OTV Link"}
                  </Button>
