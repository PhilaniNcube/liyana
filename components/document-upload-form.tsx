...
const DOCUMENT_CONFIGS = {
  ...
  [DOCUMENT_TYPES.PAYSLIP]: {
    title: "Payslip",
    description: "Upload your most recent 3 months payslip",
    icon: Receipt,
    allowedTypes: ["application/pdf", "image/*"] as string[],
    maxFileSize: 10 * 1024 * 1024, // 10MB
  },
  [DOCUMENT_TYPES.PROOF_OF_RESIDENCE]: {
    ...
    description: "Upload a utility bill or lease agreement",
    icon: Home,
    allowedTypes: ["application/pdf", "image/*"] as string[],
    maxFileSize: 10 * 1024 * 1024, // 10MB
  },
...
function DocumentUploadSection({
  ...
  applicationId: string;
  existingDocument?: Database["public"]["Tables"]["documents"]["Row"];
  onUploadSuccess: (
  ...
  const isUploaded = existingDocument !== undefined;
  // Handle file upload
...
export function DocumentUploadForm({
  ...
  const getDocumentByType = (type: DocumentType) =>
    localDocuments.find((doc) => doc.document_type === type);
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {uploadedDocuments}/{totalDocuments} completed
                </span>
              </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {Object.values(DOCUMENT_TYPES).map((documentType) => (
          <DocumentUploadSection
            ...
            existingDocument={getDocumentByType(documentType)}
