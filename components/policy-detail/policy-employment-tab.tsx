      ...
      {employmentDetails?.beneficiary && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The person designated to receive the claim payout amount when the principal member is deceased
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {employmentDetails.beneficiary.name || "N/A"}
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium">Date of Birth / ID Number</p>
                <p className="text-sm text-muted-foreground">
                  {employmentDetails.beneficiary.dob_or_id || "N/A"}
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium">Relationship</p>
                <p className="text-sm text-muted-foreground capitalize">
                  {employmentDetails.beneficiary.relationship || "N/A"}
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium">Cellphone Number</p>
                <p className="text-sm text-muted-foreground">
                  {employmentDetails.beneficiary.phone || "N/A"}
                </p>
              </div>
            </div>
          </CardContent>
