...
import { Send, MessageSquare, Clock, Phone, Shield, Edit } from "lucide-react";
...
export default function SmsPolicy({
  ...
  const handleSendSms = async () => {
    ...
    if (!editablePhoneNumber) {
      toast.error("No phone number available for this policy holder");
      return;
    }
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              id="sms-message"
              placeholder={`Hi ${policyHolderName}, regarding your policy #${policyId}...`}
              value={message}
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm">
                Send your first SMS to {policyHolderName}
              </p>
            </div>
          ) : (
